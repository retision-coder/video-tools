...
**📥 下载安装包：[视频水印擦除工具 v1.5.0 一键安装包（164MB，免联网免管理员）](https://github.com/retision-coder/video-tools/releases/latest)**
...
双击 `installer/视频水印擦除工具_Setup_v1.5.0.exe`，向导一键安装
...
```
视频水印擦除工具_Setup_v1.5.0.exe /S /D=C:\安装目录
```
